...
public class CommandReplace implements ICommand {
    private final String mTag;
    private final Object mParam;
    private List<Pair<View, String>> mTransitions;

    public CommandReplace(String tag, Object param) {
        super();
        mTag = tag;
        mParam = param;
    }

    public CommandReplace(String tag, Object param, List<Pair<View, String>> transitions) {
        super();
        mTag = tag;
        mParam = param;
